...
public class DefaultTokenService : ITokenService
{
    ...
    public virtual async Task<Token> CreateAccessTokenAsync(TokenCreationRequest request)   // <-----------------------------------tg
    {
        request.Validate();
...
public class TokenResponseGenerator : ITokenResponseGenerator
{
    ...
    protected virtual async Task<(string accessToken, string refreshToken)> CreateAccessTokenAsync(ValidatedTokenRequest request) // <------------tg, request contains scopes that
...
internal class TokenEndpoint : IEndpointHandler
{
    ...
    private async Task<IEndpointResult> ProcessTokenRequestAsync(HttpContext context)
    {
        ...
        var response = await _responseGenerator.ProcessAsync(requestResult);  // <------------tg, _responseGenerator is ITokenResponseGenerator which generates access token etc

...
namespace ExampleApp.Pages
{
    ...
    {
        public ExternalAccountConfirmModel(UserManager<AppUser> userManager, SignInManager<AppUser> signInManager)
        {
        ...
        public async Task<IActionResult> OnPostAsync(string username)
        {
            ...
            if (info != null)
            {
                ...
                if (result.Succeeded)
                {
                    await UserManager.AddClaimAsync(AppUser, new Claim(ClaimTypes.Role, "User"));

...
namespace ExampleApp.Identity
{
    public class PasswordValidator : IPasswordValidator<AppUser>
    {
        ...
        private async Task<IEnumerable<IdentityError>> CheckHaveIBeenPwned(string password)
        {
            ...
            match.StartsWith(secondSection, StringComparison.CurrentCultureIgnoreCase));
            ...
            else
            {
                ...
                return new[] {new IdentityError { Description = $"Password has been compromised {count} times" }};
            }
        }
        ...
        private static string[] commonPasswords = new[] { "123456", "123456789", "qwerty", "password", "1111111", "12345678", "abc123", "1234567", "password1", "12345", "1234567890", "123123", "000000", "Iloveyou", "1234", "1q2w3e4r5t", "Qwertyuiop", "123", "Monkey", "Dragon"};
    }
}
